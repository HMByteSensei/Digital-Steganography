...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        Dialog.setObjectName("Text Steganography")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.comboBox.setItemText(0, _translate("Dialog", "Marking Letters"))
        self.comboBox.setItemText(1, _translate("Dialog", "Uppercase Letters"))
        self.comboBox.setItemText(2, _translate("Dialog", "Uppercase Letters in Binary"))
    ...
    def handleButtonClick(self):
        try:
            ...
            if not my.engine(str(self.ui.filename.text()), str(self.ui.textEdit.toPlainText()), combo, encRadio, stegRadio):
                self.showMessageBox("Error", "There is a problem with your secret text.")
        except Exception as e:
